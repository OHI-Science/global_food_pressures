...
food_files_pressure <- list.files("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_raw", full=TRUE, pattern = pressure)
...
filename = sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/farm_pressure_%s.tif", pressure),
...
filename = sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/feed_pressure_%s.tif", pressure),
overwrite=TRUE, progress="text")
...
filename = sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/fish_pressure_%s.tif", pressure),
overwrite=TRUE, progress="text")

## combine farm, feed, fish
total_pressure_stack <- stack(sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/fish_pressure_%s.tif", pressure),
      sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/feed_pressure_%s.tif", pressure),
      sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/scenarios/scenarios_analysis/scenarios_tmp/farm_pressure_%s.tif", pressure))
...
write_csv(rescale_data, here("_analysis/scenarios/fisheries_disturbance_rescale_values.csv"))
```
