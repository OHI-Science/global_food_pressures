...
ben_catch_summary <- catch %>%
  dplyr::filter(IYear == 2017, species_class_fin == "Benthic", forage_fish == 0) %>%
...
benthic_dest_tonnes <- ben_catch_summary %>%
...
sum(benthic_dest_tonnes$total_tonnes) # 2285685
...
projectRaster(benthic_dest_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/dem_dest_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

ben_dest <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/dem_dest_mol_per_km2.tif")
plot(ben_dest)

ben_dest <- ben_dest * 0.9344789 * 0.9344789

# these should be similar
cellStats(ben_dest, "sum", na.rm=TRUE) # 730324.9
cellStats(benthic_dest_tonnes_npp, "sum", na.rm=TRUE) # 725870.5
writeRaster(ben_dest, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pressures/dem_dest.tif", overwrite=TRUE)
...
benthic_nondest_tonnes <- ben_catch_summary %>%
...
sum(benthic_nondest_tonnes$total_tonnes) # 2278206
...
projectRaster(benthic_nondest_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/dem_nondest_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

ben_nondest <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/dem_nondest_mol_per_km2.tif")
ben_nondest <- ben_nondest * 0.9344789 * 0.9344789

# these should be similar
cellStats(ben_nondest, "sum", na.rm=TRUE) # 754595.2
cellStats(benthic_nondest_tonnes_npp, "sum", na.rm=TRUE) # 750219.8
writeRaster(ben_nondest, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pressures/dem_nondest_lb.tif", overwrite=TRUE)
...
pelagic_tonnes <- ben_catch_summary %>%
...
projectRaster(pelagic_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pelagic_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

pelagic <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pelagic_mol_per_km2.tif")
pelagic <- pelagic * 0.9344789 * 0.9344789
# these should be similar
cellStats(pelagic, "sum", na.rm=TRUE)
cellStats(pelagic_tonnes_npp, "sum", na.rm=TRUE)
writeRaster(pelagic, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pressures/pel_lb.tif", overwrite=TRUE)
...
```{r, eval = FALSE}
stress_files <- list.files("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/pressures", 
...
foreach(row = 1:dim(vulnerability_clean)[1], .packages="dplyr") %dopar%{ # row=1
  ...
  raster::overlay(combo_stack, fun=function(x,y){(x*y*vuln)}, 
          filename = sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/hab_stressor_combo/%s__%s.tif", 
...
vuln <- list.files("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/hab_stressor_combo", full=TRUE)

vuln_stack <- stack(vuln)

calc(vuln_stack, fun=sum, na.rm=TRUE, filename="/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/summed_hab_stressor_combo/sum_hab_stressors_combo.tif", progress="text", overwrite=TRUE)
...
vuln <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/summed_hab_stressor_combo/sum_hab_stressors_combo.tif")
plot(vuln)
...
cellStats(vuln_avg_agg, stat=sum, na.rm=TRUE) # 1708664
...
plot(vuln_rescaled_latlon, main = "Benthic disturbance")
...
## save benthic layer
writeRaster(vuln_rescaled_latlon_area,  "/home/shares/food-systems/Food_footprint/all_food_systems/datalayers/marine_benthic_fisheries_meat_disturbance.tif", overwrite=TRUE)


## make csv
disturbance_benthic_df <- as.data.frame(vuln_rescaled_latlon, xy = TRUE)
names(disturbance_benthic_df)[3] <- "benthic_disturbance_km2"

 write_csv(disturbance_benthic_df, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/marine_benthic_fisheries_meat_disturbance.csv")
```

Datacheck: 
```{r}
check_dist <- raster(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/datalayers/marine_benthic_fisheries_meat_disturbance.tif"))
plot(check_dist)
cellStats(check_dist, "sum") # 187290.2 

disturbance_benthic_df <- as.data.frame(check_dist, xy = TRUE)

test <- read_csv(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/benthic/marine_benthic_fisheries_meat_disturbance.csv"))
sum(test$benthic_disturbance_km2, na.rm = TRUE) # 187290.2
```
