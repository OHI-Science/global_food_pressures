...
pel_catch_summary <- catch %>%
  dplyr::filter(IYear == 2017, species_class_fin == "Medium pelagic", forage_fish == 0) %>%
...
sum(benthic_dest_tonnes$total_tonnes) ## should be 0
...
projectRaster(benthic_dest_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dem_dest_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

ben_dest <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dem_dest_mol_per_km2.tif")
plot(ben_dest)
...
writeRaster(ben_dest, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pressures/dem_dest.tif", overwrite=TRUE)
...
sum(benthic_nondest_tonnes$total_tonnes)
...
projectRaster(benthic_nondest_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dem_nondest_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

ben_nondest <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dem_nondest_mol_per_km2.tif")
...
writeRaster(ben_nondest, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pressures/dem_nondest_lb.tif", overwrite=TRUE)
...
sum(pelagic_tonnes$total_tonnes)
 # 6798572
...
projectRaster(pelagic_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pelagic_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

pelagic <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pelagic_mol_per_km2.tif")
pelagic <- pelagic * 0.9344789 * 0.9344789

# these should be similar
cellStats(pelagic, "sum", na.rm=TRUE) #2328611
cellStats(pelagic_tonnes_npp, "sum", na.rm=TRUE) #2313990
writeRaster(pelagic, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pressures/pel_lb.tif", overwrite=TRUE)
...
projectRaster(pelagic_tonnes_npp_km2, hab_raster, filename = "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dest_pelagic_mol_per_km2.tif", method="ngb",
    overwrite=TRUE, progress="text")

pelagic <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/dest_pelagic_mol_per_km2.tif")
pelagic <- pelagic * 0.9344789 * 0.9344789

# these should be similar
cellStats(pelagic, "sum", na.rm=TRUE) #555205
cellStats(pelagic_tonnes_npp, "sum", na.rm=TRUE) #551796.2
writeRaster(pelagic, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pressures/pel_hb.tif", overwrite=TRUE)
...
```{r, eval = FALSE}
stress_files <- list.files("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/pressures", 
...
foreach(row = 1:dim(vulnerability_clean)[1], .packages="dplyr") %dopar%{ # row=1
  ...
  raster::overlay(combo_stack, fun=function(x,y){(x*y*vuln)}, 
          filename = sprintf("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/hab_stressor_combo/%s__%s.tif", 
...
vuln <- list.files("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/hab_stressor_combo", full=TRUE)

vuln_stack <- stack(vuln)

calc(vuln_stack, fun=sum, na.rm=TRUE, filename="/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/summed_hab_stressor_combo/sum_hab_stressors_combo.tif", progress="text", overwrite=TRUE)
...
vuln <- raster("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/summed_hab_stressor_combo/sum_hab_stressors_combo.tif")
plot(vuln)
...
cellStats(vuln_avg_agg, stat=sum, na.rm=TRUE) # 2613805 
cellStats(vuln_avg, stat=sum, na.rm=TRUE) # 2613805
plot(vuln_avg_agg)
...
plot(vuln_rescaled_latlon, main = "Meduim pelagic disturbance")
...
## save medium pelagic layer
writeRaster(vuln_rescaled_latlon_area,  "/home/shares/food-systems/Food_footprint/all_food_systems/datalayers/marine_medium-pelagic_fisheries_meat_disturbance.tif", overwrite=TRUE)


## make csv
disturbance_medium_pel_df <- as.data.frame(vuln_rescaled_latlon, xy = TRUE)
names(disturbance_medium_pel_df)[3] <- "medium_pel_disturbance_km2"

 write_csv(disturbance_medium_pel_df, "/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/marine_medium-pelagic_fisheries_disturbance.csv")
...
```{r}
check_dist <- raster(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/datalayers/marine_medium-pelagic_fisheries_meat_disturbance.tif"))
plot(check_dist)
cellStats(check_dist, "sum") # 284745.1 -  

disturbance_medium_pel_df <- as.data.frame(check_dist, xy = TRUE)

test <- read_csv(file.path("/home/shares/food-systems/Food_footprint/all_food_systems/dataprep/fisheries/marine/disturbance/medium_pelagic/marine_medium-pelagic_fisheries_disturbance.csv"))
sum(test$medium_pel_disturbance_km2, na.rm = TRUE) # 284745.1
```
