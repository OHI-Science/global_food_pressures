...
write.csv(fao_tuna_taxa_prod, here("aquaculture/marine/tuna/tuna_farms/data/fao_mariculture_tuna_taxa_production.csv"), row.names=FALSE)
...
write.csv(fao_tuna, here("aquaculture/marine/tuna/tuna_farms/data/fao_mariculture_tuna.csv"), row.names=FALSE)
        
 explore <- read_csv(here("aquaculture/marine/tuna/tuna_farms/data/fao_mariculture_tuna.csv")) %>%
   filter(year==2017) %>%
